...
class ResConfigSettings(models.TransientModel):
    ...
    # --- Print Agent ---------------------------------------------------
    pos_nsoft_print_agent_url = fields.Char(
        related='pos_config_id.nsoft_print_agent_url', readonly=False)
    pos_nsoft_printer_host = fields.Char(
        related='pos_config_id.nsoft_printer_host', readonly=False)
    pos_nsoft_printer_port = fields.Integer(
        related='pos_config_id.nsoft_printer_port', readonly=False)
