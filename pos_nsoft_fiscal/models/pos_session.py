...
class PosSession(models.Model):
    ...
    def print_nsoft_x_report(self):
        ...
        try:
            self._send_nsoft_x_report()
        except NSoftAPIError as exc:
            return _notification("i.EKA klaida", str(exc), 'danger')
        return _notification("X Ataskaita", "X ataskaita suformuota ir pasirašyta.")
    ...
    def print_nsoft_z_report(self):
        ...
        try:
            ...
            return _notification("i.EKA klaida", str(exc), 'danger')
        return _notification("Z Ataskaita", "Fiskalinė diena uždaryta.")
